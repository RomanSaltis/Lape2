...
// echo $owner->getOwnerName().PHP_EOL;
echo $owner->getAutoAndOwner();
// echo "Owner ".$owner->getOwnerName().PHP_EOL;
// echo $owner->getCarName();
// echo "Owner is ".$owner->getAutoAndOwner()." his car is ".$owner->getCarName()."\n";
// echo "Now answer: ".$owner->getAutoAndOwner();
