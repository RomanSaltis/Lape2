...
echo '<br> 6 uzd. <br> sukurkite funkciją kuri išspausdina kokį nors tekstą. <br><br><br>' ;
...
echo '<br> <br> <br> 6.b uzd. <br> sukurkite funkciją kuri priima vieną parametrą ir išspausdina tekstas "labas" +
tas paduotas kintamasis <br><br><br>' ;


$zmogus = 'Petras'; // nera skirtumo koks kintamojo pavadinimas, nueis i funkcija
priimaparametra('Jonas');
priimaparametra($zmogus);

function priimaparametra($tigras) {
    echo 'Labas ' . $tigras . '<hr>';
}


echo '<br> <br> <br> 6.c uzd. <br> sukurkite funkciją kuri gražina skaičiaus PI pirmus 8 skaičius <br><br><br>' ;
...
echo '<br> <br> <br> 6. d uzd sukurkite funkciją kuri gražina dviejų parametrų sąndaugą. <br><br><br>' ;
...
echo '<br> <br> <br> 6. e. <br> sukurkite funkciją kuri apskaičiuoja skritulio PLOTĄ. ši funkcija priima 1 parametrą
bei naudoja 1c. funkciją savo viduje, kad gautų PI reikšmę. <br><br><br>' ;

echo circleSq(5) . '<br>';
function circleSq($r){
    return 2 * nmyPi() * pow($r, 2);
}
...
echo '<br> <br>  6 f. <br> sukurkite funkciją kuri apskaičiuoja skritulio ILGĮ. ši funkcija priima 1 parametrą
// bei naudoja 1c. funkciją savo viduje, kad gautų PI reikšmę. <br><br><br>' ;

echo circleLength(5) . '<hr>';
...
echo '<br> <br> 6. g. <br> sukurkite funkciją kuri: priima vieną parametrą. savyje iškviecia 1e ir 1f funkcijas
ir atspausdina:
apskritimo ilgis: (tai ka gražino funkcija 1f)
apskritimo plotas: (tai ka gražino funkcija 1g) <br><br><br>' ;


cirkle(20);
function cirkle($r){
    echo 'apskritimo ilgis: ' . circleLength($r) . '<hr>';
    echo 'apskritimo plotas: ' . circleSq($r) . '<hr>';
