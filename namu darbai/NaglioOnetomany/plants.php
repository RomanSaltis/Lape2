...
<div class="container bg-light">
    ...
    <form class="form" action="" method="POST">
        ...
        <div class="form-group row">
         ...
         <input type="hidden" name="plant_id" value="<?php if(isset($_GET['id'])){echo $_GET['id'];}else{echo $_GET['plant_id'];}?>">
    <?php if(!isset($plant)){
...
<!-- 
<?php if(isset($_GET['id'])){echo $_GET['id'];}else{echo $_GET['plant_id'];}?>
<?=(isset($_GET['id'])) ? $_GET['id'] : $_GET['plant_id']?> -->