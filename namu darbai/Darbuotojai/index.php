...
<body>
    ...
    <div class="form-group row">
        ...
        <div class="form-group row">
        <label class="col-sm-2 col-form-label">Surename</label>
        <div class="col-sm-4">
            <input class="form-control" type="text" name="Surename">
        </div>
    </div>
        <div class="form-group row">
    ...
    <table class="table">
        ...
        <tr>
            <!-- <td> <?= $_SESSION['darbuotojai'][0]['Name'] ?></td> -->
        </tr>
    </table>
